...
#define  SHELL_TRACE_LEVEL_INFO                          1
#endif

#ifndef  SHELL_TRACE_LEVEL_DEBUG
#define  SHELL_TRACE_LEVEL_DEBUG                         2
#endif
...
#define  SHELL_TRACE_INFO(x)                  ((SHELL_TRACE_LEVEL >= SHELL_TRACE_LEVEL_INFO)  ? (void)(SHELL_TRACE x) : (void)0)
#define  SHELL_TRACE_DEBUG(x)                 ((SHELL_TRACE_LEVEL >= SHELL_TRACE_LEVEL_DEBUG) ? (void)(SHELL_TRACE x) : (void)0)
