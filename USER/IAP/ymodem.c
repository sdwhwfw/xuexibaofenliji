      ...
      switch (Receive_Packet(packet_data, &packet_length, NAK_TIMEOUT))
      {
        case 0:
          ...
          switch (packet_length)
          {
            ...
            default:
              /* CRC high */
			  crc_value = (packet_data[packet_length + PACKET_HEADER] << 8) & 0xFF00;
			  /* CRC low */
			  crc_value |= (packet_data[packet_length + PACKET_HEADER + 1]) & 0x00FF;
			  crc_temp = Cal_CRC16(&packet_data[PACKET_HEADER], packet_length);
