                       ...
                       SHELL_ERR  *perr)
{
    ...
    while (pmodule_cmd != (SHELL_MODULE_CMD *)0) {
        name_compare = strcmp(pmodule_cmd->Name, ptbl_name);
    ...
    if (Shell_ModuleCmdFreePoolPtr != (SHELL_MODULE_CMD *)0) {  /* If module cmd pool NOT empty ...                     */
       ...
       *perr =  SHELL_ERR_MODULE_CMD_NONE_AVAIL;                /* ... rtn err.                                         */
        return;
                                                                ...
                                                                /* ----------------- INIT MODULE CMD ------------------ */
    strcpy(pmodule_cmd->Name, ptbl_name);
                       ...
                       SHELL_ERR  *perr)
{
    ...
    while (pmodule_cmd_list != (SHELL_MODULE_CMD *)0) {
        name_compare = strcmp(cmd_tbl_name, pmodule_cmd_list->Name);
        if (name_compare == 0) {
                                         ...
                                         SHELL_ERR  *perr)
{
    ...
    while (pmodule_cmd_list != (SHELL_MODULE_CMD *)0) {
        name_compare = strcmp(module_cmd_name, pmodule_cmd_list->Name);
        if (name_compare == 0) {
            pmodule_cmd = pmodule_cmd_list;
            break;
        }
    ...
    while (pcmd_list->Fnct != (SHELL_CMD_FNCT)0) {
        name_compare = strcmp(cmd_name, pcmd_list->Name);
        if (name_compare == 0) {
            pcmd  = pcmd_list;
            break;
        }
                                      ...
                                      SHELL_ERR   *perr)
{
    ...
    copy_ret_val = strncpy(module_cmd_name, cmd_str, name_len);
