...
#define  SHELL_CFG_CMD_TBL_SIZE                            8    /* Cfg Shell cmd tbl size  (see Note #1).               */
#define  SHELL_CFG_CMD_ARG_NBR_MAX                        16    /* Cfg cmd max nbr of arg  (see Note #2).               */

#define  SHELL_CFG_MODULE_CMD_NAME_LEN_MAX                12    /* Cfg module cmd name len (See Note #3).               */
...
#ifndef  TRACE_LEVEL_ON
#define  TRACE_LEVEL_ON                                   1u
#endif

#ifndef  SHELL_TRACE_LEVEL_INFO
#define  SHELL_TRACE_LEVEL_INFO                           1u
#endif
...
#define  SHELL_TRACE_LEVEL                    TRACE_LEVEL_ON
#define  SHELL_TRACE                               APP_TRACE
