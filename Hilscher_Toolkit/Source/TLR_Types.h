...
*******************************************************************************
  ...
  Last Modification:
    @version $Id: TLR_Types.h 1750 2010-06-23 08:34:03Z MichaelT $
...
#if !defined (__GNUC__) && !defined (__MSVC__) && !defined (__ADS__) && !defined (__REALVIEW__) && !defined(__TLR_USE_CUSTOM_COMPILER__) && !defined (__CC_ARM)
