...
*******************************************************************************
  ...
  Last Modification:
    @version $Id: rcX_User.h 3167 2011-12-12 12:58:20Z Robert $
  ...
  ---------------------------------------------------------------------------
    2011-12-12  RM            Updated ulHWFeatures definitions for extended memory (MRAM)
    2011-12-06  RM            Added ulHWFeatures into SYSTEM_STATUS_BLOCK (RTC/MRAM)
    2011-10-31  MS            Added RCX_HW_DEV_CLASS_NETRAPID_10/50
    2011-07-07  MS            Added PROT_CLASS_3S_PLC_HANDLER
    2010-12-10  MS            Added RCX_HW_DEV_CLASS_NETJACK_10/50/100/500 and RCX_HW_DEV_CLASS_NETLINK_10_USB
    2010-11-29  UJ            fixed Mantis 11689 (update rcx_user.h (sync stuff))
    2010-11-15  RH            Added RCX_HW_DEV_CLASS_COMX_50
                              Added RCX_PROT_CLASS_VARAN
    2010-11-10  RH            Added RCX_HW_DEV_CLASS_COMX_10
    ...
    2010-09-02  MT            Added RCX_HW_DEV_CLASS_CHIP_NETX_10
    2010-08-03  SB            Added RCX_E_INVALID_ALIGNMENT
    2010-07-22  MT            Added RCX_PROT_CLASS_DF1
    2010-05-04  ABessler      Added HW option validation start/end defines
...
#if defined (__ADS__) || defined (__REALVIEW__) || defined (__CC_ARM)
...
/*****************************************************************************/
typedef __packed struct NETX_SYSTEM_CHANNEL_INFOtag
{
...
/*****************************************************************************/
typedef __packed struct NETX_HANDSHAKE_CHANNEL_INFOtag
{
  uint8_t   bChannelType;                                        /*!< 0x00 Type of this channel */
...
/*****************************************************************************/
typedef __packed struct NETX_COMMUNICATION_CHANNEL_INFOtag
{
  uint8_t   bChannelType;                                        /*!< 0x00 Type of this channel */
...
/*****************************************************************************/
typedef __packed struct NETX_APPLICATION_CHANNEL_INFOtag
{
  uint8_t   bChannelType;                                        /*!< 0x00 Type of this channel */
  uint8_t   bChannelId;                                          /*!< 0x01 Channel / Port ID */
  uint8_t   bSizePositionOfHandshake;                            /*!< 0x02 Size and position of the handshake cells */
...
/*****************************************************************************/
typedef __packed struct NETX_SYSTEM_INFO_BLOCKtag
{
...
/*****************************************************************************/
typedef __packed union NETX_CHANNEL_INFO_BLOCKtag
{
...
/*****************************************************************************/
typedef __packed struct NETX_SYSTEM_CONTROL_BLOCKtag
{
...
/*****************************************************************************/
typedef __packed struct NETX_SYSTEM_STATUS_BLOCKtag
{
...
/*****************************************************************************/
typedef __packed struct NETX_SYSTEM_SEND_MAILBOXtag
{
...
/*****************************************************************************/
typedef __packed struct NETX_SYSTEM_RECV_MAILBOXtag
{
...
/*****************************************************************************/
typedef __packed union NETX_HANDSHAKE_CELLtag
{
  __packed struct
  {
...
/*****************************************************************************/
typedef __packed struct NETX_SYSTEM_CHANNELtag
{
...
/*****************************************************************************/
typedef __packed struct NETX_HANDSHAKE_ARRAYtag
{
...
/*****************************************************************************/
typedef __packed struct NETX_MASTER_STATUStag
{
...
/*****************************************************************************/
typedef __packed struct NETX_HANDSHAKE_BLOCKtag
{
...
/*****************************************************************************/
typedef __packed struct NETX_CONTROL_BLOCKtag
{
...
/*****************************************************************************/
typedef __packed struct NETX_COMMON_STATUS_BLOCKtag
{
...
/*****************************************************************************/
typedef __packed struct NETX_EXTENDED_STATUS_BLOCKtag
{
...
typedef __packed struct NETX_EXTENDED_STATE_STRUCT_Ttag
{
...
typedef __packed struct NETX_EXTENDED_STATE_FIELD_Ttag
{
...
typedef __packed struct NETX_EXTENDED_STATE_FIELD_DEFINITION_Ttag
{
...
/*****************************************************************************/
typedef __packed struct NETX_SEND_MAILBOX_BLOCKtag
{
...
/*****************************************************************************/
typedef __packed struct NETX_RECV_MAILBOX_BLOCKtag
{
...
/*****************************************************************************/
typedef __packed struct NETX_DEFAULT_COMM_CHANNELtag
{
...
/*****************************************************************************/
typedef __packed struct RCX_PACKET_HEADERtag
{
...
/*****************************************************************************/
typedef __packed struct RCX_PACKETtag
{
...
typedef __packed struct tagNETX_FW_VERSION
{
  uint16_t    usMajor;
  uint16_t    usMinor;
  uint16_t    usBuild;
...
typedef __packed struct tagNETX_FW_NAME
{
  uint8_t bNameLength;
  uint8_t abName[ 63 ];
} __RCX_PACKED_POST NETX_FW_NAME;

typedef __packed struct tagNETX_FW_DATE
{
  uint16_t  usYear;
  uint8_t   bMonth;
  uint8_t   bDay;
...
typedef __packed struct tagNETX_FW_IDENTIFICATION
{
...
typedef __packed struct tagNETX_HW_NAME
{
  uint8_t bNameLength;
  uint8_t abName[ 63 ];
