...
*****************************************************************************************
    ...
    Filename:
     $Workfile: NetX_RegDefs.H $ $Revision: 1236 $
    Last Modification:
     $Author: MichaelT $
    ...
    Description:
      ...
      NetX_RegDefs.h : netX register definitions for DPM/DMA access

    Changes:

      Revision  Date        Author      Description
      -----------------------------------------------------------------------------------
      3         21.04.10    MT          - DMA Triple Buffer definition updated (was an error in manual)
      2         06.12.06    RM          - obsoleted #pragma once removed

      1         08.08.06    MT          created
