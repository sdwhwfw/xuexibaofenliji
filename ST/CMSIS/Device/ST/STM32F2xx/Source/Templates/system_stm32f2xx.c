...
/*
 ...
 | PD10 <-> FSMC_D15 | PE11 <-> FSMC_D8   | PF12 <-> FSMC_A6 | PG9 <-> FSMC_NE2 | ---> PD7 <-> FSMC_NE1
...
*/
  ...
  GPIOD->AFR[0]  = 0xc0cc00cc;    // 0x00cc00cc
  GPIOD->AFR[1]  = 0xcc0ccccc;    // 0xcc0ccccc
  /* Configure PDx pins in Alternate function mode */
  GPIOD->MODER   = 0xa2aa8a0a;    // 0xa2aa0a0a
  /* Configure PDx pins speed to 100 MHz */
  GPIOD->OSPEEDR = 0xf3ffcf0f;    // 0xf3ff0f0f
...
/*-- FSMC Configuration ------------------------------------------------------*/
  ...
  FSMC_Bank1->BTCR[0]  = 0x00005011;   // FSMC_Bank1->BTCR[2]  = 0x00001015;
  FSMC_Bank1->BTCR[1]  = 0x00000202;   // FSMC_Bank1->BTCR[3]  = 0x00010400;
  FSMC_Bank1E->BWTR[0] = 0x00000202;   // FSMC_Bank1E->BWTR[2] = 0x0fffffff;
/*
