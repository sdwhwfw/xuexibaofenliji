 ...
 *******************************************************************************/
#ifndef _APP_SLAVE_BOARD1_H
#define _APP_SLAVE_BOARD1_H
...
GLOBAL SensorState sensor_state_handle;//need init
GLOBAL PumpState1 pump_state1_handle; //need init
GLOBAL PumpState2 pump_state2_handle; //need init

/*total moved distance*/
GLOBAL volatile uint16_t draw_pump_total_distance;
GLOBAL volatile uint16_t AC_pump_total_distance;
GLOBAL volatile uint16_t feedback_pump_total_distance;

/*old single moved distance*/
GLOBAL volatile uint16_t AC_pump_old_single_distance;
GLOBAL volatile uint16_t draw_pump_old_single_distance;
GLOBAL volatile uint16_t feedback_pump_old_single_distance;
...
GLOBAL OS_TMR* tmr_draw_pump_timeout;
GLOBAL OS_TMR* tmr_AC_pump_timeout;
GLOBAL OS_TMR* tmr_feedback_pump_timeout;

GLOBAL volatile u8 flag_tmr_draw_pump_timeout;
GLOBAL volatile u8 flag_tmr_AC_pump_timeout;
GLOBAL volatile u8 flag_tmr_feedback_pump_timeout;
/*for pump direction*/
GLOBAL OS_TMR* tmr_draw_pump_direction;
GLOBAL OS_TMR* tmr_AC_pump_direction;
GLOBAL OS_TMR* tmr_feedback_pump_direction;

GLOBAL volatile u8 flag_tmr_draw_pump_dir;
GLOBAL volatile u8 flag_tmr_AC_pump_dir;
GLOBAL volatile u8 flag_tmr_feedback_pump_dir;

/*for AC_bubble detect*/
GLOBAL OS_TMR* tmr_AC_bubble;
GLOBAL volatile u8 flag_tmr_AC_bubble;
...
void init_slave_board1_task(void);



#undef GLOBAL

#endif /* _APP_SLAVE_BOARD1_H */
